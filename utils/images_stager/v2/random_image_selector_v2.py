#!/usr/bin/env python3
"""
Image Stitched Folder Processor - Enhanced Edition
...
def create_manifest(output_file, tasks_completed, config, start_time, end_time, filters):
    """
...
def process_stitched_images(args):
    ...
    if args.manifest:
        ...
        create_manifest(manifest_path, completed_tasks, config, start_time, end_time, filters)
...
def create_parser():
    ...
    parser = argparse.ArgumentParser(
        description='Advanced image stitching processor with comprehensive options',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  # Fast compression with default settings
  ...
  # Process all images (not just stitched folders)
